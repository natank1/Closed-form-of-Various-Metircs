...
#KL special cases for Gaussians

#KL divergence between multi varaite Gaussian and idnep (namelu a Gaussian with diagonal covaraince matrix)
#Inputs Multi variate Gaussiian & Indepdnednet
...
#KL divergence between indepndendt and the standard normal dist
#Inputs: Indepdnedent
